        ...
        <div className="col">
          <div className="progress" style={{ height: "20px" }}>
            <div
              ...
              aria-valuemin="0"
              aria-valuemax="100"
              aria-valuenow={loadingBarWidth()} // TODO: Increase aria-valuenow as elapsed time increases
              style={{ width: `${loadingBarWidth()}%` }} // TODO: Increase width % as elapsed time increases
            />
          </div>
        </div>
      </div>
